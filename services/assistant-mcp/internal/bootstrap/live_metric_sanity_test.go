...
func summarizeLiveMetric(view string, series []liveMetricSeries) (liveMetricSummary, error) {
	...
	summary := liveMetricSummary{Series: len(series), Min: math.Inf(1), Max: math.Inf(-1)}
...
func TestSummarizeLiveMetric(t *testing.T) {
	...
	if err != nil || summary.Series != 1 || summary.Samples != 2 || summary.Min != 20 || summary.Max != 25 || summary.Latest != 25 {
