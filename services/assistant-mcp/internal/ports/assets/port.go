...
type Port interface {
	Knowledge(id, version string) (Asset, error)
	Skill(id, version string) (Asset, error)
	Playbook(id, version, digest string) (Playbook, error)
	Resolve(Alert) (Resolution, error)
}
