...
"$frontend/node_modules/.bin/redocly" lint --config "$root/redocly.yaml" "$root/contracts/openapi/order-demo.yaml"
"$frontend/node_modules/.bin/redocly" lint --config "$root/redocly.yaml" "$root/contracts/openapi/order-demo-fault.yaml"
"$frontend/node_modules/.bin/redocly" lint --config "$root/redocly.yaml" "$root/contracts/tools/grafana/tools.openapi.yaml"
"$frontend/node_modules/.bin/redocly" lint --config "$root/redocly.yaml" "$root/contracts/tools/incident/tools.openapi.yaml"
