...
|G4：Frontend|进行中|Resource list client、Unicode 首消息标题、Session page 去重、Session-only route 和 Session-aware reducer 已实现；10 个文件 29 个单测与 TypeScript 通过，待接 SessionPane、无限分页和三栏重排。|
