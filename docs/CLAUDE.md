...
[`implementation/intent_planner_structured_output_hardening_progress.md`](implementation/intent_planner_structured_output_hardening_progress.md).
...
[`implementation/session_history_workbench_progress.md`](implementation/session_history_workbench_progress.md), and its privacy/activity decision is
[`adr/ADR-022-private-session-history.md`](adr/ADR-022-private-session-history.md).
...
| `implementation/order_service_incident_remediation_execution_plan.md` | Completed execution plan | Controllable order-service incident diagnosis, approval, typed remediation, recovery and audit slice. |
| `implementation/order_service_incident_remediation_progress.md` | Completed progress record | Gate status and verification evidence for the order-service incident slice. |
