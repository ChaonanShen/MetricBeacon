...
The active grouped chart-canvas refinement is
...
| `implementation/grouped_chart_canvas_execution_plan.md` | Active execution plan | Chronological Task-grouped charts with a maximum two-column responsive canvas. |
| `implementation/grouped_chart_canvas_progress.md` | Active progress record | Gate status and verification evidence for the grouped chart canvas. |
